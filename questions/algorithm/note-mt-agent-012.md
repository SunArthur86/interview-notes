...
**30 秒电梯演讲：** 就像洗扑克牌从中间劈开一张正序一张逆序交错插入。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】手撕：重排链表（LeetCode 143） | "就像洗扑克牌从中间劈开一张正序一张逆序交错插入。" | 引入 |
| 0:20 | 概念图解 | "快慢指针找中点" | 快慢指针找中点 |
| 0:45 | 对比表格 | "反转链表后半段" | 反转链表后半段 |
| 1:15 | 代码截图 | "双指针交错合并" | 双指针交错合并 |
| 1:45 | 总结卡 | "记住三个词：快慢指针找中点、反转链表后半段、双指针交错合并" | 收尾 |
