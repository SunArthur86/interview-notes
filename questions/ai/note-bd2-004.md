...
**30 秒电梯演讲：** 就像人脑——短期记忆是"现在正在想的事"(工作记忆, 容量小但快)，长期记忆是"过去的经历"(海马体→皮层, 容量大但需要检索)
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：Agent的Memory如何进行管理？存在哪些地方？ | "就像人脑——短期记忆是"现在正在想的事"(工作记忆, 容量小但快)，长期记忆是"过去的经历"(海马体" | 引入 |
| 0:20 | 概念图解 | "对话历史，存在上下文窗口中，生命周期=单次会话" | 短期记忆 |
| 0:45 | 对比表格 | "向量库/数据库存储，跨会话持久化" | 长期记忆 |
| 1:15 | 代码截图 | "从长期记忆中检索出的当前相关上下文" | 工作记忆 |
| 1:45 | 总结卡 | "记住三个词：短期记忆、长期记忆、工作记忆" | 收尾 |
