...
**30 秒电梯演讲：** 像聊天——连贯就是接得住话，你提"那个电影"我知道指上次聊的，不会突兀跳话题。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：多轮对话的连贯性如何保持？ | "像聊天——连贯就是接得住话，你提"那个电影"我知道指上次聊的，不会突兀跳话题。" | 引入 |
| 0:20 | 概念图解 | "上下文丢失/话题跳跃/指代不明" | 三大原因 |
| 0:45 | 对比表格 | "上下文管理+话题追踪+指代消解" | 对策 |
| 1:15 | 代码截图 | "追问确认+话题切换提示" | 主动机制 |
| 1:45 | 总结卡 | "记住三个词：三大原因、对策、主动机制" | 收尾 |
