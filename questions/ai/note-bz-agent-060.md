...
**30 秒电梯演讲：** 像建房子的脚手架——不提供房子本身(LLM)，但提供搭房子的框架和工具，让你专注设计而非砌砖。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：LangChain 框架有哪些应用场景？ | "像建房子的脚手架——不提供房子本身(LLM)，但提供搭房子的框架和工具，让你专注设计而非砌砖。" | 引入 |
| 0:20 | 概念图解 | "LLM应用开发框架（脚手架）" | 定位 |
| 0:45 | 对比表格 | "Models/Prompts/Chains/Agents/Memory/Retrieval" | 核心组件 |
| 1:15 | 代码截图 | "快速开发/组件丰富/生态好" | 优势 |
| 1:45 | 总结卡 | "记住三个词：定位、核心组件、优势" | 收尾 |
