...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：RAG 有哪些优化技巧？（十种） | "像钓鱼——选对鱼饵(查询改写)、多撒几竿(多路召回)、挑大鱼(重排)、选好钓点(分块)。" | 引入 |
| 0:20 | 概念图解 | "查询改写/HyDE/多查询/混合检索/Rerank/分块/元数据/参数/上下文扩展/反馈" | 十种技巧 |
| 0:45 | 对比表格 | "三类" | 分检索前/中/后 |
| 1:15 | 代码截图 | "多路召回+精排" | 核心思想 |
| 1:45 | 总结卡 | "记住三个词：十种技巧、分检索前/中/后、核心思想" | 收尾 |
