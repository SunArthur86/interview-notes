...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【腾讯面经】多 Agent 协同机制怎么设计的？ | "就像一个开发团队——有 PM 拆需求、架构师设计、开发写代码、QA 测试，每个角色有明确职责和协作协" | 引入 |
| 0:20 | 概念图解 | "角色定义与分工" | 角色定义与分工 |
| 0:45 | 对比表格 | "通信协议" | 通信协议 |
| 1:15 | 代码截图 | "冲突解决机制" | 冲突解决机制 |
| 2:15 | 总结卡 | "记住三个词：角色定义与分工、通信协议、冲突解决机制" | 收尾 |
