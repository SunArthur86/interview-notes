...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】你用了多少AI Coding来开发Agent系统 | "就像问厨师用了多少预制菜回答要有层次框架用AI核心手写测试AI辅助架构人工。" | 引入 |
| 0:20 | 概念图解 | "vs核心逻辑" | 分层回答样板代码 |
| 0:45 | 对比表格 | "展示人机协作流程" | 展示人机协作流程 |
| 1:15 | 代码截图 | "诚实但有策略" | 诚实但有策略 |
| 1:45 | 总结卡 | "记住三个词：分层回答样板代码、展示人机协作流程、诚实但有策略" | 收尾 |
