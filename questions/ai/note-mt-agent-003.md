...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】简述Agent的基本架构组成，并解释其与传统LL | "LLM Chain就像火车轨道铺好的AI是引擎但方向人定，Agent就像自动驾驶汽车AI自己决定走哪" | 引入 |
| 0:20 | 概念图解 | "感知模块解析输入" | 感知模块解析输入 |
| 0:45 | 对比表格 | "规划模块推理决策" | 规划模块推理决策 |
| 1:15 | 代码截图 | "理" | 记忆模块上下文管 |
| 1:45 | 总结卡 | "记住三个词：感知模块解析输入、规划模块推理决策、记忆模块上下文管" | 收尾 |
