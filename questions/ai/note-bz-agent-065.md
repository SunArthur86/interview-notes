...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：LangGraph 的核心 Graph 如何设计？如何打造企 | "像设计企业SOP——不是简单的线性流程，而是有审批/并行/回退/子流程的复杂网络，LangGraph" | 引入 |
| 0:20 | 概念图解 | "多节点/条件分支/子图/并行" | 复杂图 |
| 0:45 | 对比表格 | "显式State对象" | 状态管理 |
| 1:15 | 代码截图 | "审批/确认" | 人工节点 |
| 2:15 | 总结卡 | "记住三个词：复杂图、状态管理、人工节点" | 收尾 |
