...
**30 秒电梯演讲：** Function Call等于直接打电话，MCP等于电话簿标准，Skills等于完整业务流程打包。

**展开框架：**
1. **Function** — Call原子操作厂商原生
2. **MCP统一协议开** — 放标准
3. **Skills能力** — 组合多Tool加Prompt
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】Function Call到MCP到Skills | "Function Call等于直接打电话，MCP等于电话簿标准，Skills等于完整业务流程打包。" | 引入 |
| 0:20 | 概念图解 | "Call原子操作厂商原生" | Function |
| 0:45 | 对比表格 | "放标准" | MCP统一协议开 |
| 1:15 | 代码截图 | "组合多Tool加Prompt" | Skills能力 |
| 2:15 | 总结卡 | "记住三个词：Function、MCP统一协议开、Skills能力" | 收尾 |
