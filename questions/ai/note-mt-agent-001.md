...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】为什么选 PostgreSQL？它的特点是什么？ | "就像全能瑞士军刀——MySQL是精简小刀，MongoDB是万能钳，PostgreSQL是那把什么都干" | 引入 |
| 0:20 | 概念图解 | "(含可序列化)" | ACID完整支持 |
| 0:45 | 对比表格 | "塞" | MVCC读写不阻 |
| 1:15 | 代码截图 | "NB半结构化支持" | JSON/JSO |
| 1:45 | 总结卡 | "记住三个词：ACID完整支持、MVCC读写不阻、JSON/JSO" | 收尾 |
