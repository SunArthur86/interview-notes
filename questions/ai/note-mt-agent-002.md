...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】你的Agent项目用的是什么架构？master加 | "就像项目组——PM负责任务拆解，前端后端QA各负责专项，但前后端可以直接沟通不用事事绕回PM。" | 引入 |
| 0:20 | 概念图解 | "度" | 主控负责任务级调 |
| 0:45 | 对比表格 | "信息级同步" | 子Agent负责 |
| 1:15 | 代码截图 | "slave" | 非纯master |
| 2:15 | 总结卡 | "记住三个词：主控负责任务级调、子Agent负责、非纯master" | 收尾 |
