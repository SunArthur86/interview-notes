...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】多智能体如何解决无限循环或者信息冗余问题？ | "无限循环就像两个人互相说你说需要一个裁判来打破僵局。信息冗余就像群里10人转发同一条消息需要公告板。" | 引入 |
| 0:20 | 概念图解 | "测循环模式" | 监督Agent检 |
| 0:45 | 对比表格 | "or回退" | 中断信号强制总结 |
| 1:15 | 代码截图 | "作记忆区" | 内容冗余用共享工 |
| 2:15 | 总结卡 | "记住三个词：监督Agent检、中断信号强制总结、内容冗余用共享工" | 收尾 |
