...
**30 秒电梯演讲：** 像训练销售——客户反馈(买不买/满不满意)是奖励，销售通过试错学会"什么时候推荐什么、怎么说话客户爱听"。

**展开框架：**
1. **对话=序列决策** — 回复=动作，满意度=奖励
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：基于强化学习的对话策略如何优化？ | "像训练销售——客户反馈(买不买/满不满意)是奖励，销售通过试错学会"什么时候推荐什么、怎么说话客户爱" | 引入 |
| 0:20 | 概念图解 | "回复=动作，满意度=奖励" | 对话=序列决策 |
| 0:45 | 对比表格 | "即时(点赞)+延迟(留存/任务完成)" | 奖励设计 |
| 1:15 | 代码截图 | "RLHF/RLAIF/DPO" | 方法 |
| 2:15 | 总结卡 | "记住三个词：对话=序列决策、奖励设计、方法" | 收尾 |
