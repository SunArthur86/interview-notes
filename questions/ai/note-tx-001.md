...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【腾讯面经】Memory Agent 的奖励设计怎么做？ | "像训练管家——他记住的东西有没有用？用了记住的东西做出的菜好不好吃（任务奖励）？经常翻笔记说明笔记有" | 引入 |
| 0:20 | 概念图解 | "接但延迟长" | 下游任务奖励最直 |
| 0:45 | 对比表格 | "证的即时信号" | 检索引用率是可验 |
| 1:15 | 代码截图 | "用的记忆" | 记忆效率惩罚从不 |
| 2:15 | 总结卡 | "记住三个词：下游任务奖励最直、检索引用率是可验、记忆效率惩罚从不" | 收尾 |
