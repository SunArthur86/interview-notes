...
**30 秒电梯演讲：** 像银行大堂经理——先问你要办什么(意图)，引导到对应窗口(技能)，复杂的找主管(人工)，事后总结经验(学习)。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：智能客服 Agent 如何设计？FAQ 匹配算法怎么优化？ | "像银行大堂经理——先问你要办什么(意图)，引导到对应窗口(技能)，复杂的找主管(人工)，事后总结经验" | 引入 |
| 0:20 | 概念图解 | "意图路由→技能处理→人工协作" | 架构 |
| 0:45 | 对比表格 | "向量+关键词+Rerank混合" | FAQ匹配 |
| 1:15 | 代码截图 | "无缝转接+上下文传递" | 人工协作 |
| 1:45 | 总结卡 | "记住三个词：架构、FAQ匹配、人工协作" | 收尾 |
