...
**30 秒电梯演讲：** 像同时学钢琴和绘画——练琴多了画技退步，画画多了琴技生疏。解法是合理分配时间（配比）、先打基础再专攻（课程学习）、定期复习保持（回放）。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【八股总结】多领域数据混训如何避免某能力提升导致其他下降？ | "像同时学钢琴和绘画——练琴多了画技退步，画画多了琴技生疏。解法是合理分配时间（配比）、先打基础再专攻" | 引入 |
| 0:20 | 概念图解 | "新数据梯度覆盖旧能力" | 灾难性遗忘 |
| 0:45 | 对比表格 | "按领域重要性 + 难度加权" | 配比策略 |
| 1:15 | 代码截图 | "先通用后专业，先易后难" | 课程学习 |
| 1:45 | 总结卡 | "记住三个词：灾难性遗忘、配比策略、课程学习" | 收尾 |
