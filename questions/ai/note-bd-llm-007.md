...
**30 秒电梯演讲：** 就像评估一个研究员——要看他查资料的能力(检索)和写报告的能力(生成)，不能只看最终报告。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【字节面经】如何评估 RAG 系统的回答质量？你用过 RAG | "就像评估一个研究员——要看他查资料的能力(检索)和写报告的能力(生成)，不能只看最终报告。" | 引入 |
| 0:20 | 概念图解 | "Faithfulness/Answer Relevancy/Context Precision/Context R..." | RAGAS四维度 |
| 0:45 | 对比表格 | "Recall@K/MRR/NDCG" | 检索评估 |
| 1:15 | 代码截图 | "BLEU/ROUGE/LLM-as-Judge" | 生成评估 |
| 2:15 | 总结卡 | "记住三个词：RAGAS四维度、检索评估、生成评估" | 收尾 |
