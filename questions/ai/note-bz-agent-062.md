...
**30 秒电梯演讲：** LangChain像多功能瑞士军刀(啥都能干)，LlamaIndex像专业手术刀(RAG这件事做得最精)。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：LlamaIndex 在 RAG 系统中的架构？ | "LangChain像多功能瑞士军刀(啥都能干)，LlamaIndex像专业手术刀(RAG这件事做得最" | 引入 |
| 0:20 | 概念图解 | "专注数据框架/RAG" | 定位 |
| 0:45 | 对比表格 | "数据连接/索引/查询引擎" | 核心 |
| 1:15 | 代码截图 | "RAG相关功能更深更全" | 优势 |
| 1:45 | 总结卡 | "记住三个词：定位、核心、优势" | 收尾 |
