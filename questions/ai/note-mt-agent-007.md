...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】短期记忆和长期记忆有什么区别？ | "短期记忆等于工作台正在处理的文件，长期记忆等于档案柜验证过的经验。" | 引入 |
| 0:20 | 概念图解 | "上下文" | 短期记忆当前步骤 |
| 0:45 | 对比表格 | "识" | 长期记忆跨会话知 |
| 1:15 | 代码截图 | "即弃" | 短期高频读写过期 |
| 2:15 | 总结卡 | "记住三个词：短期记忆当前步骤、长期记忆跨会话知、短期高频读写过期" | 收尾 |
