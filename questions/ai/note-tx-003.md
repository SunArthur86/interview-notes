...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【腾讯面经】Skill 怎么设计的？为什么不用 Skill  | "手动设计Skill像请专业厨师写菜谱（精确可控），Skill Creator像让AI生成菜谱（快但可" | 引入 |
| 0:20 | 概念图解 | "可控/安全/可维护" | 手动 |
| 0:45 | 对比表格 | "快但不稳定/难调试" | 自动 |
| 1:15 | 代码截图 | "生产环境优先手动" | 生产环境优先手动 |
| 1:45 | 总结卡 | "记住三个词：手动、自动、生产环境优先手动" | 收尾 |
