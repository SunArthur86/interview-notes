...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：多轮对话中，如果不同轮次的记忆发生冲突，你如何处理？ | "就像微信备注更新——朋友改名了你会更新备注（时间戳优先），如果不确定就问一句"你现在叫什么？"（主动" | 引入 |
| 0:20 | 概念图解 | "最新信息覆盖旧信息" | 时间戳优先 |
| 0:45 | 对比表格 | "用户明确陈述 > 对话推断 > 模型假设" | 置信度加权 |
| 1:15 | 代码截图 | "记录记忆变更历史，支持回溯" | 版本化管理 |
| 1:45 | 总结卡 | "记住三个词：时间戳优先、置信度加权、版本化管理" | 收尾 |
