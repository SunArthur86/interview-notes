...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：文档问答系统的检索召回率如何提升？ | "像图书馆找书——好的检索词(查询优化)、多种索引方式(混合检索)、让馆员帮你挑(Rerank)、合理" | 引入 |
| 0:20 | 概念图解 | "改写/HyDE/多查询" | 查询 |
| 0:45 | 对比表格 | "混合(向量+BM25)" | 检索 |
| 1:15 | 代码截图 | "Rerank精选" | 排序 |
| 1:45 | 总结卡 | "记住三个词：查询、检索、排序" | 收尾 |
