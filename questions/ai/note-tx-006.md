...
**30 秒电梯演讲：** 科研Agent像F1赛车（只追求速度不计成本），工业Agent像出租车（要省油/安全/舒适/7x24运行）。赛车技术可以下放到出租车，但需要大量工程改造。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【腾讯面经】科研场景和工业场景的 Agent 有什么区别？ | "科研Agent像F1赛车（只追求速度不计成本），工业Agent像出租车（要省油/安全/舒适/7x24" | 引入 |
| 0:20 | 概念图解 | "验证新方法/Benchmark驱动" | 科研 |
| 0:45 | 对比表格 | "解决业务/成本敏感/SLA要求" | 工业 |
| 1:15 | 代码截图 | "成本/稳定/延迟/安全/可观测/评估" | 落地6大考虑 |
| 1:45 | 总结卡 | "记住三个词：科研、工业、落地6大考虑" | 收尾 |
