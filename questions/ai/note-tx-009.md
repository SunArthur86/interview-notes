...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【腾讯面经】该项目与 Claude Code 的核心差异在哪 | "就像对比自研 RPC 框架 vs gRPC——功能可能重叠，但设计取舍完全不同。" | 引入 |
| 0:20 | 概念图解 | "略" | 上下文窗口处理策 |
| 0:45 | 对比表格 | "工具调用机制" | 工具调用机制 |
| 1:15 | 代码截图 | "多语言支持" | 多语言支持 |
| 2:15 | 总结卡 | "记住三个词：上下文窗口处理策、工具调用机制、多语言支持" | 收尾 |
