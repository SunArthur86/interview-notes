...
**30 秒电梯演讲：** 像USB标准——不管U盘/摄像头/键盘，都用USB接口。Skill标准让不管什么能力，都以统一形式接入Agent。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：如何基于统一规范实现"万物皆可 Skill"？ | "像USB标准——不管U盘/摄像头/键盘，都用USB接口。Skill标准让不管什么能力，都以统一形式接" | 引入 |
| 0:20 | 概念图解 | "元数据+工具+流程+Schema" | 统一规范 |
| 0:45 | 对比表格 | "API/脚本/知识/流程/人都能封装" | 万物 |
| 1:15 | 代码截图 | "标准化集成，降低成本" | 价值 |
| 1:45 | 总结卡 | "记住三个词：统一规范、万物、价值" | 收尾 |
