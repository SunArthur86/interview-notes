...
**30 秒电梯演讲：** 就像餐饮菜单系统——麦当劳和肯德基的套餐不同，但都运行在同一个点餐系统上。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】如果不同活动下规则组合不一样，系统要怎么支持？ | "就像餐饮菜单系统——麦当劳和肯德基的套餐不同，但都运行在同一个点餐系统上。" | 引入 |
| 0:20 | 概念图解 | "规则集模板" | 规则集模板 |
| 0:45 | 对比表格 | "规则集绑定" | 活动 |
| 1:15 | 代码截图 | "规则继承覆盖" | 规则继承覆盖 |
| 2:15 | 总结卡 | "记住三个词：规则集模板、活动、规则继承覆盖" | 收尾 |
