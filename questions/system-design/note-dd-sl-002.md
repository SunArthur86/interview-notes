...
**30 秒电梯演讲：** 就像快递中转站——你寄到一个简短地址，中转站查到真实地址后告诉你转寄到这里。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】短链跳转的原理是什么？用的是什么 HTTP 状态 | "就像快递中转站——你寄到一个简短地址，中转站查到真实地址后告诉你转寄到这里。" | 引入 |
| 0:20 | 概念图解 | "永久重定向（可缓存）" | 301 |
| 0:45 | 对比表格 | "临时重定向（可统计）" | 302 |
| 1:15 | 代码截图 | "保持方法" | 307/308 |
| 1:45 | 总结卡 | "记住三个词：301、302、307/308" | 收尾 |
