...
**30 秒电梯演讲：** 就像换书架上的书——你不是一本一本换，而是提前摆好新书架然后一把整体换掉。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】如果奖品概率配置临时变了，概率查找表怎么更新？ | "就像换书架上的书——你不是一本一本换，而是提前摆好新书架然后一把整体换掉。" | 引入 |
| 0:20 | 概念图解 | "On-Write替换引用" | Copy |
| 0:45 | 对比表格 | "保证可见性" | volatile |
| 1:15 | 代码截图 | "双缓冲切换" | 双缓冲切换 |
| 2:15 | 总结卡 | "记住三个词：Copy、volatile、双缓冲切换" | 收尾 |
