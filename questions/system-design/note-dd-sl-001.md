...
**30 秒电梯演讲：** 就像推销一款产品——你要说清楚为什么要做、怎么做、最后赚了多少钱。

**展开框架：**
1. **业务痛点（长UR** — L不美观/统计困难）
2. **技术选型（发号器** — +Redis+分库分表）
3. **量化效果（QPS** — /存储量/响应时间）
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】做短链项目的出发点是什么？用了哪些技术？最后达到 | "就像推销一款产品——你要说清楚为什么要做、怎么做、最后赚了多少钱。" | 引入 |
| 0:20 | 概念图解 | "L不美观/统计困难）" | 业务痛点（长UR |
| 0:45 | 对比表格 | "+Redis+分库分表）" | 技术选型（发号器 |
| 1:15 | 总结卡 | "记住三个词：业务痛点（长UR、技术选型（发号器、量化效果（QPS" | 收尾 |
