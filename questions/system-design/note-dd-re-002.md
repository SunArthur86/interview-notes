...
**30 秒电梯演讲：** 就像流水线加一道工序——新工序只需接到流水线末端或中间，其他工序完全不变。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】你前面提到用责任链和组合模式做规则引擎，那新增的 | "就像流水线加一道工序——新工序只需接到流水线末端或中间，其他工序完全不变。" | 引入 |
| 0:20 | 概念图解 | "口" | 实现IRule接 |
| 0:45 | 对比表格 | "注册到责任链" | 注册到责任链 |
| 1:15 | 代码截图 | "注入" | Spring自动 |
| 2:15 | 总结卡 | "记住三个词：实现IRule接、注册到责任链、Spring自动" | 收尾 |
