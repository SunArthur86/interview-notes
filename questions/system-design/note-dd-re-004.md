...
**30 秒电梯演讲：** 就像交通规则——红灯和绿灯同时出现时，交警按红灯停的绝对优先级来决定。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【滴滴面经】如果规则之间存在优先级冲突怎么办？比如黑名单和V | "就像交通规则——红灯和绿灯同时出现时，交警按红灯停的绝对优先级来决定。" | 引入 |
| 0:20 | 概念图解 | "）" | 绝对优先级（短路 |
| 0:45 | 对比表格 | "权重投票" | 权重投票 |
| 1:15 | 代码截图 | "互斥组" | 互斥组 |
| 2:15 | 总结卡 | "记住三个词：绝对优先级（短路、权重投票、互斥组" | 收尾 |
