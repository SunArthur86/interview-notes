...
**30 秒电梯演讲：** 就像用吸管喝超大杯奶茶不能一口闷要一口一口吸。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【美团面经】Python如何读取大文件？ | "就像用吸管喝超大杯奶茶不能一口闷要一口一口吸。" | 引入 |
| 0:20 | 概念图解 | "line in f逐行迭代" | for |
| 0:45 | 对比表格 | "chunk size分块" | read |
| 1:15 | 总结卡 | "记住三个词：for、read、二进制模式处理无" | 收尾 |
