...
**30 秒电梯演讲：** 就像2010年的移动端——从简单App到复杂生态，AI桌面正从'聊天框'进化到'生产力平台'。

**展开框架：**
1. **Agent任务编** — 排(多步/多Agent/断点续传)
2. **产物质量护栏(D** — iff/确认/回滚)
3. **本地AI集成(端** — 侧推理/离线能力)
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【月之暗面面经】你怎么看桌面 AI 产品前端未来一年的主战场 | "就像2010年的移动端——从简单App到复杂生态，AI桌面正从'聊天框'进化到'生产力平台'。" | 引入 |
| 0:20 | 概念图解 | "排(多步/多Agent/断点续传)" | Agent任务编 |
| 0:45 | 对比表格 | "iff/确认/回滚)" | 产物质量护栏(D |
| 1:15 | 代码截图 | "侧推理/离线能力)" | 本地AI集成(端 |
| 2:15 | 总结卡 | "记住三个词：Agent任务编、产物质量护栏(D、本地AI集成(端" | 收尾 |
