...
**30 秒电梯演讲：** 就像评价一家餐厅——上菜速度(性能)、顾客回头率(业务)、菜品口味(AI质量)三个维度缺一不可。

**展开框架：**
1. **体验** — TTI/FCP/交互延迟/帧率
2. **业务** — 任务完成率/产物采纳率/D1D7留存
3. **AI质量** — 回答准确率/幻觉率/用户满意度评分
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【月之暗面面经】你会用哪些指标判断桌面 AI 产品前端做得好 | "就像评价一家餐厅——上菜速度(性能)、顾客回头率(业务)、菜品口味(AI质量)三个维度缺一不可。" | 引入 |
| 0:20 | 概念图解 | "TTI/FCP/交互延迟/帧率" | 体验 |
| 0:45 | 对比表格 | "任务完成率/产物采纳率/D1D7留存" | 业务 |
| 1:15 | 代码截图 | "回答准确率/幻觉率/用户满意度评分" | AI质量 |
| 1:45 | 总结卡 | "记住三个词：体验、业务、AI质量" | 收尾 |
