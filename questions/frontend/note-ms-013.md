...
**30 秒电梯演讲：** 就像Git Diff——新手看Summary（修改了3个文件），高手看具体的每行代码变更，一个界面两种深度。

**展开框架：**
1. **摘要层** — 新手看"AI改了什么+为什么"
2. **行级层** — 高手看精确的行/Token对比
3. **视图切换** — 按需展开更多细节
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【月之暗面面经】如何设计 AI 桌面端的产物 diff，既能 | "就像Git Diff——新手看Summary（修改了3个文件），高手看具体的每行代码变更，一个界面两" | 引入 |
| 0:20 | 概念图解 | "新手看"AI改了什么+为什么"" | 摘要层 |
| 0:45 | 对比表格 | "高手看精确的行/Token对比" | 行级层 |
| 1:15 | 代码截图 | "按需展开更多细节" | 视图切换 |
| 2:15 | 总结卡 | "记住三个词：摘要层、行级层、视图切换" | 收尾 |
