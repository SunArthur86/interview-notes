...
**30 秒电梯演讲：** 就像快递App——下单后不是盯着页面等，而是收到通知'已到驿站'，点进去查看包裹，有问题可以补充信息重新投递。
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：【月之暗面面经】桌面端长任务执行时，前端怎样做通知、回看和继 | "就像快递App——下单后不是盯着页面等，而是收到通知'已到驿站'，点进去查看包裹，有问题可以补充信息" | 引入 |
| 0:20 | 概念图解 | "任务状态" | 任务中心统一管理 |
| 0:45 | 对比表格 | "键结果不塞细节" | 系统通知只提示关 |
| 1:15 | 代码截图 | "和原上下文" | 点通知回到原任务 |
| 1:45 | 总结卡 | "记住三个词：任务中心统一管理、系统通知只提示关、点通知回到原任务" | 收尾 |
