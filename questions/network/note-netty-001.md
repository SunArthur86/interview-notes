...
**30 秒电梯演讲：** 原生 Java NIO 就像一台手动挡赛车——跑得快但离合、换挡、油离配合全要自己来，新手很容易熄火。Netty 就是给这台赛车装上了自动变速箱 + 辅助驾驶，你只需要踩油门（写业务逻辑），底层复杂操作它全帮你搞定。

**展开框架：**
1. **本质=异步+事件** — 驱动+基于NIO
2. **解决网络IO/多** — 线程并发/编程技巧三大领域的复杂性
3. **五大特性** — 设计/易用/性能/安全/社区

**收尾：** Netty 相比直接用 Java NIO 简化了什么？
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡：Netty 是什么？为什么需要它？ | "原生 Java NIO 就像一台手动挡赛车——跑得快但离合、换挡、油离配合全要自己来，新手很容易熄火" | 引入 |
| 0:20 | 概念图解 | "驱动+基于NIO" | 本质=异步+事件 |
| 0:45 | 对比表格 | "线程并发/编程技巧三大领域的复杂性" | 解决网络IO/多 |
| 1:15 | 总结卡 | "记住三个词：本质=异步+事件、解决网络IO/多、五大特性" | 收尾 |
